            ...
            <div class="row">
                <div class="card">
                    <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>   
                                            <div class="card-body text-center">
                                                <div class="buttons">                                
                                                    <a href="{{route('edit_objection', ['id' => $objection->id])}}" class="btn btn-secondary">تعديل</a>
                                                    <a href="{{route('delete_objection', ['id' => $objection->id])}}" class="btn btn-danger">تراجع</a>
                                                </div>
                                            </div>
                                        </td>
                                        @else
                        ...
                        @else
                        <h3 class="text-center">لا يوجد لديك اعتراضات</h3>
                        @endif

                        <div class="card-body text-center">
                            <div class="buttons">
                                <a href="{{route('objections.create')}}" class="btn btn-outline-dark">إضافة اعتراض</a>
