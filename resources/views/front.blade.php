...
@section('content')
    ...
    @foreach ($supervisor as $item)
       @php
           $super_name= DB::table('users')->where('id', $item->user_id)->latest()->first()->name;
           $previous_advisor= DB::table('users')->where('id', $item->previous_advisor)->latest()->first()->name;
            if ($item->current_advisor == '0'){
                $status = "غير مكلف";
                $current_advisor= "ليس لديك موجه";
            }
            else {
                $status = "مكلف";
                $current_advisor= DB::table('users')->where('id', $item->current_advisor)->latest()->first()->name;
            }
       @endphp
                                ...
                                <div class="card-body px-3 py-4-5">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <h6 class="font-extrabold mb-0">{{$current_advisor}}</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body px-3 py-4-5">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <h6 class="font-extrabold mb-0">{{$previous_advisor}}</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body px-3 py-4-5">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <h6 class="font-extrabold mb-0">{{$item->created_at->toDateString()}}</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-body py-4 px-5">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-3 name" style="padding: 10px;">
                                    <h5 class="font-bold">{{$super_name}} </h5>
